<?php
include_once 'script/config.inc';
?>
<!DOCTYPE html>
<html>
<head>
...
<div id='wrapper'>
    <div class='application'>
        <div class='application-content'>
            <a href="index.php" boder="0"><div class='icon-heart'></div>
    ...
    <div class='controls'>
        ...
        <div class='form-wrapper'>
            ...
            <div style="margin:0;padding:0;display:inline">
                <input id="r" type="hidden" value="<?php echo $_REQUEST['r'];?>" /></div>
                <div class='row-fluid'>
                ...
                <label id="error" style="color:orange;"></label>
                <button class="btn btn-block" name="button" type="submit" id="submit">Sign in</button>
            </form>
...
$(document).ready(function(){
	$("#submit").click(function(){
        ...
        $.ajax({
            ...
            url :   "script/api.php",
            dataType:   'json',
            data:   'action=userLogin&user='+$("#email").val()+'&pass='+$("#password").val(),
