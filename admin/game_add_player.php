...
$race = $raceModel->getAllList();
$teamModel = new TeamModel();
$team = $teamModel->getAllList();
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <form enctype="multipart/form-data" id='myform' style="margin-bottom: 0;" method="post" class="form form-horizontal" action="game_add_player_image.php" accept-charset="UTF-8"><div style="margin:0;padding:0;display:inline"><input type="hidden" value="✓" name="utf8"><input type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" name="authenticity_token"></div>
        <div class="control-group">
                ...
                <div class="control-group" id="logurl" style="display:none;">
                    ...
                    <div class="controls">
                        <input type="text" placeholder="请输入头像网络地址" name="logurl">
                    </div>
                </div>
                <div class="control-group" id="logfile">
                    <label for="inputText2" class="control-label">上传logo</label>
                    <div class="controls">
                        <input type="file" placeholder="请选择头像" name="logfile">
                    </div>
                </div>
        <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="row-fluid">
                            <div class='span6'>
                                <div class='row-fluid'>
                                    <select class='select2 input-block-level' placeholder='请输入类型...' name='races' id='races'>
                                        <optgroup label='选择种族'>
                                            <?php 
                                                foreach($race as $arr){
        ...
        <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" placeholder="游戏ID" name="gameid" id='gameid'>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" placeholder="外号" name="nickname" id='nickname'>
                    </div>
                </div>

        <div class="control-group">
                    <label class="control-label">所在战队</label>
                    <div class="controls">
                        <div class="row-fluid">
                            <div class='span6'>
                                <div class='row-fluid'>
                                    <select class='select2 input-block-level' placeholder='请输入战队...' name='team' id='team'>
                                        <optgroup label='所有战队'>
                                            <option value="0"/>请选择
                                            <?php 
                                                foreach($team as $arr){
        ...
        <div class="control-group">
                    <label class="control-label">曾效力战队</label>
                    <div class="controls">
                        <div class="row-fluid">
                            <div class='span6'>
                                <div class='row-fluid'>
                                    <select class='select2 input-block-level' multiple="multiple" placeholder='请输入战队...' name='teams' id='teams'>
                                        <optgroup label='所有战队'>
                                            <?php 
                                                foreach($tags as $arr){
                                                    echo '<option value=\''. $arr[TeamModel::_id] .'\' />' . $arr[TeamModel::_name]; 
