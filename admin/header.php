...
<!--                    <li class='dropdown light only-icon'>
                    ...
                    <li class='dropdown dark user-menu'>
                        <a class='dropdown-toggle' data-toggle='dropdown' href='#'>
                            ...
                            <span class='user-name hidden-phone'><?php echo $_SESSION[UserHelper::USER_NAME];?></span>
                            <b class='caret'></b>
                        </a>
                        <ul class='dropdown-menu'>
                            <li>
                ...
                <form accept-charset="UTF-8" action="<?php echo $_SERVER["SCRIPT_NAME"];?>" class="navbar-search pull-right hidden-phone" method="get" /><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
                    <button class="btn btn-link icon-search" name="button" type="submit"></button>
                    <input autocomplete="off" class="search-query span2" id="q_header" name="<?php echo $key; ?>" placeholder="Search..." type="text" value="<?php echo $_REQUEST[$key]; ?>" />
                </form>
            </div>
        </div>
    </div>
