...
include_once 'model/TeamImageModel.php';
...
$teamImage = new TeamImageModel();
$team_image = $teamImage->getTeamImage($id);
//print_r($team_image);exit;
?>
<!DOCTYPE html>
<html>
<head>
...
<div class='alert alert-info' id="alert" style="display:none;">
    ...
    <form enctype="multipart/form-data" id='myform' style="margin-bottom: 0;" method="post" class="form form-horizontal" action="" accept-charset="UTF-8"><div style="margin:0;padding:0;display:inline"><input type="hidden" value="✓" name="utf8"><input type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" name="authenticity_token"></div>
                <div class="control-group">
                    <label for="inputText1" class="control-label">战队logo</label>
                    <div class="controls" id="logo_view">
                        <image border="0" src="<?php echo $team[TeamModel::_logo]?>" style="float:left;margin-right:10px;max-height:30px;"/>
                    </div>      
                </div> 
               
                <div class="control-group" id="logurl" >
                    <label for="inputText2" class="control-label">战队logo</label>
                    <div class="controls">
                        <input type="text" placeholder="请输战队logo" name="logourl" id="logourl" value="<?php echo $team[TeamModel::_logo]?>">
                    </div>
                </div>
                                        ...
                                        <optgroup label='所有国家'>
                                            ...
                                            <?php 
                                                ...
                                                foreach($country as $arr){
                                                    echo '<option value=\''. $arr[CountryModel::_id] .'\' '. isEqual($arr[CountryModel::_id], $team[TeamModel::_country]) .'/>' . $arr[CountryModel::_name]; 
                                                }
                                            ?>
                                        </optgroup>
                                    </select>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" placeholder="战队名称" name="name" id='name' value="<?php echo $team[TeamModel::_name];?>" />
                    </div>
                </div>
                ...
                <div class="control-group" id="parent_id">
                    ...
                    <div class="controls">
                        <div class="row-fluid">
                            <div class='span6'>
                                <div class='row-fluid'>
                                    <select class='select2 input-block-level' placeholder='请输入教练关键字...' name='coach' id='coach'>
                                        <optgroup label='所有教练'>
                                            <option value="0"/>请选择
                                            <?php
                                                foreach($coachs as $arr){
                                                    echo '<option value=\''. $arr[CoachModel::_id] .'\' '. isEqual($arr[CoachModel::_id], $team[TeamModel::_coach_id]) .'/>' . $arr[CoachModel::_name]; 
                                                }
                                            ?>
                                        </optgroup>
                                    </select>
                                        ...
                                        <optgroup label='所有队员'>
                                            <?php 
                                                ...
                                                foreach($players as $arr){
                                                    echo '<option value=\''. $arr[PlayerModel::_id] .'\' '. checked($arr[PlayerModel::_id], $player_arr) . ' />' . $arr[PlayerModel::_name]; 
                                                }
                                            ?>
                                        </optgroup>
                                    </select>
    ...
    <form enctype="multipart/form-data" id='myform' style="margin-bottom: 0;" method="post" class="form form-horizontal" action="player_upload_file.php" accept-charset="UTF-8"><div style="margin:0;padding:0;display:inline"><input type="hidden" value="✓" name="utf8"><input type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" name="authenticity_token"></div>
        ...
        <div class="control-group" id="image_views">
            <?php 
                ...
                foreach($team_image as $image){
                    echo '<image border="0" title="点击删除图片..." src="' . $image[TeamImageModel::_url] . '" style="margin:5px;width:200px;" />';
                }
            ?>
