 ...
 * @author koudejian
 */
class DescantController extends BaseController{
    private $file = null;
...
//        exit;
    ...
    public function addDescant(){
        ...
        //3.插入数据
        $descantMode = new DescantModel();
        $result = $descantMode->add($name, $remark);
    ...
    public function updateDescant(){
        ...
        //3.修改数据
        $descantMode = new DescantModel();
        $result = $descantMode->update($id, $name, $remark);
        if($result == false || $result == null){
            return false;
        }
        return $result;
