 ...
 * @author koudejian
 */
class FixturesGroupModel extends BaseModel{
    const _table = 'starcraft_fixtures_group';
    ...
    public function getFixturesGroupName($id){
        $fixturesGroup = $this->get($id);
        if($fixturesGroup != null){
            return $fixturesGroup[self::_name];
        }else{
            return '--';
        }
    }
